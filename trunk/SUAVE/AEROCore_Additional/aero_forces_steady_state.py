...
def aero_forces_steady_state(input_details, vehicle):
    ...
    while delta_thrust > 1e-6:
        ...
        aoa_test, cl_test, cd_test = determine_alpha_steady_state(vehicle, air_properties, aero_map, input_details, gravity, mass)
...
def determine_alpha_steady_state(vehicle, air_properties, aero_map, input_details, gravity, mass ):
